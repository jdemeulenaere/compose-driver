    ...
    settings.gradle.settingsEvaluated {
        ...
        val androidProjectPath =
            extension.androidProjectName.orNull?.let {
                settings.addProject(
                    it,
                    androidBuildFile(projectName = it, driverDependency = driverDependency),
                )
            }
        val desktopProjectPath =
            extension.desktopProjectName.orNull?.let {
                settings.addProject(it, desktopBuildFile(driverDependency))
            }
...
private fun composeDriverVersion(): String {
    ...
    return props.getProperty("version").also { println("VERSION=$it") }
}
...
private fun androidBuildFile(projectName: String, driverDependency: String): String {
    return $$"""
